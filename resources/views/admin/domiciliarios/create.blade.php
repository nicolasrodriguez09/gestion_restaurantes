<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800">Nuevo domiciliario</h2>
    </x-slot>
    ...
    <div class="py-8 max-w-2xl mx-auto px-4">
        ...
        <form action="{{ route('admin.domiciliarios.store') }}" method="POST" class="space-y-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            @csrf
            <div>
